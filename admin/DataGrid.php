    ...
    <div>
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="index.php" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">Sistem Informasi</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
            <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                ...
                <div class="news-update-box hidden-xs"><span class="text-uppercase mrm pull-left text-white">News:</span>
                    <ul id="news-update" class="ticker list-unstyled">
                        <li>Welcome to Sistem Informasi - Responsive Multi-Style Admin Template</li>
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle"><img src="images/thumbs/hai.png" alt="" class="img-responsive img-circle"/>&nbsp;<span class="hidden-xs">Admin</span>&nbsp;<span class="caret"></span></a>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    </i><span class="menu-title">Download Materi</span></a>
            ...
            <div id="page-wrapper">
                                    ...
                                    <div class="box text-shadow">
                                        <table class="demo-tbl"><!--<item>1</item>-->
                                            <tr class="tbl-item"><!--<img/>-->
                                                <td class="img"><img src="images/thumbs/hai.png" style="height: 100px; width: 100px;" alt="" title=""/></td>
                                                <!--<data></data>-->
                                                <td class="td-block"><p class="date">03/15/2018</p>

                                                    <p class="title"><a href="">Algoritma Prmrograman</p></a>

                                                    <p class="desc">Pengertian Algoritma Pemrograman. ... Dalam matematika dan ilmu komputer, algoritma adalah urutan atau langkah-langkah untuk penghitungan atau untuk menyelesaikan suatu masalah yang ditulis secara berurutan. Sehingga, algoritma pemrograman adalah urutan atau langkah-langkah untuk menyelesaikan masalah pemrograman komputer.</p>

                                                    <a href="images/thumbs/hai.png" download="hai.png" class="like">Download</a>
                ...
                <div id="footer">
                    <div class="copyright">
                        <a href="http://themifycloud.com">2019 © Sistem Informasi </a></div>
                </div>
                <!--END FOOTER-->
            </div>
            <!--END PAGE WRAPPER-->
